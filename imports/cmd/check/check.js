...
Template.check.onCreated(function checkPagesOnCreated() {
...
Template.check.onRendered(function checkPagesOnRendered() {
  this.autorun(() => {
...
Template.checkStauts.helpers({
	checkName(name){
	    return name == "check" ? true : false;
	},
});
