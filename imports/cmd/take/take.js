...
Template.take.onCreated(function takePagesOnCreated() {
...
Template.take.onRendered(function takePagesOnRendered() {
  this.autorun(() => {
...
Template.takeStauts.helpers({
	checkName(name){
	    return name == "take" ? true : false;
	},
});
Template.take.events({
  'click  .take'(event, instance) {
  	 var index = 0 ;
  	 var t = FlowRouter.getParam('t');
  	 var id = FlowRouter.getParam('id');
